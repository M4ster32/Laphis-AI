 ...
 */
const PRESETS = [
  { id: "preset_1",  icon: User,     bg: "linear-gradient(135deg, #B5714D, #D4956B)", label: "Classic" },
  { id: "preset_2",  icon: Smile,    bg: "linear-gradient(135deg, #8B7DB5, #A999D4)", label: "Happy" },
  { id: "preset_3",  icon: Heart,    bg: "linear-gradient(135deg, #E0607E, #F08DA0)", label: "Heart" },
  { id: "preset_4",  icon: Star,     bg: "linear-gradient(135deg, #C49B3A, #E0BD5F)", label: "Star" },
            ...
            <button
              ...
              style={{
                ...
                boxShadow: isSelected
                  ? "0 4px 16px rgba(181, 113, 77, 0.35)"
